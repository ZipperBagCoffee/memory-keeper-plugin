...
// v3: uses CLAUDE_PROJECT_DIR (stable project root set by Claude Code)
const fs = require('fs');
const path = require('path');
const os = require('os');
...
// Read stdin, pass HOOK_DATA to child script
// CLAUDE_PROJECT_DIR (set by Claude Code) is the stable project root — don't override it
let _data = '';
let _loaded = false;
function _run() {
  if (_loaded) return;
