...
- **After Compacting or Session Restart:** (1) If .claude/memory/delta_temp.txt exists → summarize to memory.md, else skip. (2) Read latest memory.md + related docs (workflow, lessons) to rebuild understanding. (3) If understanding feels incomplete → check relevant L1 session files in .claude/memory/sessions/.
`;
