---
name: regressing
description: "Autonomous D→P→T loop with verification-based optimization. Use when iterative improvement is needed. Invoke with /regressing \"topic\" N to run N cycles of discuss→plan→ticket→execute→feedback."
---
...
1. **1 cycle = 1 D + 1 P + 1 T + 1 independent execution cycle.** No steps may be skipped.
...
6. **Use existing skill invocations.** Invoke discussing, planning, and ticketing skills internally.
